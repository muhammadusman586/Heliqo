...
import { DeployTerminal } from "@/components/landing/illustrations";
...
const steps = [
  {
    ...
    title: "Discover",
    subtitle: "& define",
    description: "Workshops to understand your users, goals, and constraints. You leave with a clear scope, timeline, and fixed quote.",
  },
  {
    number: "02",
    title: "Design",
    subtitle: "& build",
    description: "Two-week sprints with live demos. You see real, working software every week and steer as we go.",
  },
  {
    number: "03",
    title: "Launch",
    subtitle: "& grow",
    description: "We ship to production, monitor, and keep iterating. Maintenance and scaling support included.",
  },
];
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          {/* Deploy terminal — sits on top of the step cards */}
          <div className={`relative h-[360px] lg:h-[640px] overflow-hidden transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}>
            <DeployTerminal visible={isVisible} />
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-brand" : "text-white/20"
                }`}>
                  {step.number}
                </span>
                <div className="flex-1 h-px bg-white/10 overflow-hidden">
                  {activeStep === index && (
                    <div className="h-full bg-brand/50 animate-progress" />
                  )}
                </div>
              </div>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-brand transition-transform duration-500 origin-left ${
