...
const securityFeatures = [
  {
    ...
    description: "OWASP practices, code audits, encrypted data.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "NDA from day one",
    description: "Your idea stays confidential. Always.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full transparency",
    description: "Weekly demos, shared boards, open repos.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "You own the code",
    description: "Complete IP transfer, zero lock-in.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["NDA-first", "GDPR-aware", "OWASP Top 10", "Full IP transfer"];
...
export function SecuritySection() {
  ...
  return (
    <section id="why-us" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              No lock-in, no black boxes. You own everything we build — and you see every step of how we build it.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Code &amp; IP ownership, from day one</span>
              </div>
            </div>
